...
The post-16 maths support community has two large sources of resources that contain unaccessible images; Mathcentre and Helm.
...
Fortunately for the majority of the images in these resources it is relatively easy to create a digital object. Below is a categorization of the difficulty of creating these objects with some examples.

...
of recreating the resources shown in the document [Trig ratios of anysize](https://mathcentre.ac.uk/resources/uploaded/mc-ty-trigratiosanysize-2009-1.pdf).

A mock up of the [accessible version of 'Trig ratios of any size'](https://bathmash.github.io/mathcentre2.0-mockup/) was made using the resources developed over the course of this project.
